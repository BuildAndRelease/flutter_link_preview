...
public class SwiftLinkFetchPlugin: NSObject, FlutterPlugin, UIAlertViewDelegate, URLSessionDataDelegate {
    ...
    func fetchLinkInfo(url : String, completionHandler : @escaping (Dictionary<String, Any>) -> Void) {
        ...
        //飞书、小红书加host
        if let hostString = url.host, ( hostString.contains("feishu.cn") || hostString.contains("xiaohongshu.com") || hostString.contains("xhslink.com") ) {
        ...
        if let hostString = url.host, (hostString.contains("feishu.cn")) {
            request.addValue("session=U7CK1RF-c09t7d68-96e8-48b1-b4fe-dd9bf5426931-NN5W4", forHTTPHeaderField: "Cookie")
